...
Shader "Mobile/ Realistic Car Shaders/Body Color + Diffuse"
{
		...
		SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput s)
		{
			...
			body = reflectionResult * (1 - bodySpecularMask2)  + BodyDiffuse * bodySpecularMask;
            #endif
			...
			// combine everything
			s.Albedo = BodyColor * (1 - bodySpecularMask) + BodyDiffuse * bodySpecularMask + body;
		}
		ENDCG
	}
	FallBack "Standard"
	CustomEditor "SkrilStudio.VehicleDiffuse_Editor"
}
