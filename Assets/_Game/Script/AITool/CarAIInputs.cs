    ...
    public class CarAIInputs : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                if (carAIReference.currentSpeed > carAIReference.motorbikeInfo.maxSpeed * 0.1f)
                {
                    fwd = carAIReference.currentSpeed*transform.forward;
                }
    
                float desiredSpeed = carAIReference.motorbikeInfo.maxSpeed;
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            float spinningAngle = carAIReference.transform.eulerAngles.magnitude * carAIReference.cautiousAngularVelocityFactor;
                            ...
                            desiredSpeed = Mathf.Lerp(carAIReference.curSpeed, carAIReference.motorbikeInfo.maxSpeed * carAIReference.cautiousSpeedFactor, cautiousnessRequired);
                            break;
                        }
